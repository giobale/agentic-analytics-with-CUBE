...
class LLMClient:
    ...
    def __init__(self, api_key: Optional[str] = None, model: str = "gpt-4o-2024-08-06"):
        ...
        Args:
            ...
            model: OpenAI model to use (default: gpt-4o-2024-08-06 for structured outputs)
        """
        if openai is None:
    ...
    def process_query(self,
        ...
        try:
            ...
            # Call OpenAI API with Structured Outputs for guaranteed JSON format
            print("🔍 DEBUG: Calling OpenAI API with Structured Outputs (JSON Schema)...")
