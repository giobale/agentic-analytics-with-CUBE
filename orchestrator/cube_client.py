...
class CubeClient:
    ...
    def execute_query(self, cube_query: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if 'data' in result:
                ...
                # Save to CSV
                csv_filename = self._save_to_csv(data, cube_query)
    ...
    def _save_to_csv(self, data: List[Dict[str, Any]], cube_query: Dict[str, Any]) -> str:
        """
        ...
        # Create a simple name from measures and dimensions
        measures = cube_query.get("measures", [])
        dimensions = cube_query.get("dimensions", [])
